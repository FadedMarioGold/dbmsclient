...
//         <Switch>
//          <Route path="/" exact render={() => <Home/>}/>
//           <Route path="/" exact component={CurrentServices} />
//           <Route path="/currentservices" exact component={CurrentServices} />
//           <Route path="/addservice" exact component={AddServices} />
//           <Route path="/vehiclesunderservice" exact component={VehicleUnderService} />
//           <Route path="/deleteservice" exact component={DeleteService} />
//         </Switch>
//       </Router>
//     </>
//   );
